...
async function index(req, res) {
    ...
    res.json({ data: { total, completadas, pendientes: Number(stats.pendientes || 0), en_progreso: Number(stats.en_progreso || 0), porcentaje_completadas: total ? Math.round((completadas / total) * 100) : 0 }, ...stats });
}
